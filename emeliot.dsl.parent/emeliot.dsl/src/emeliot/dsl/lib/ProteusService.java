...
public class ProteusService extends EmeliotLib {
	...
	public void runTestCaseP(List<String> TS, List<String> mutatedTS, List<String> outputsTS, List<String> outputPorts) throws Exception {
...
//        restoreOriginalTS(componentPath);	        
	...
	@Override
	public void runTestCase(String proteusProject, List<String> inPortPath, List<String> outPortPath) throws Exception {
		//input checks

		long WAIT_TIME = 5000;
	    Thread.sleep(WAIT_TIME);
	    
	    Runtime.getRuntime().exec("cmd /c start " + proteusProject);
	    Thread.sleep(2 * WAIT_TIME);
	    Robot robot = new Robot();
	    for (int i = 0; i < inPortPath.size(); i++) {
	        try {
	    		//open Graph Menu 
	        	Thread.sleep(WAIT_TIME);
	            ...
	            StringSelection stringSelection = new StringSelection(outPortPath.get(i));
	    ...
	    System.out.println("PROTEUS TEST CASE " + proteusProject + " COMPLETED.");
	}

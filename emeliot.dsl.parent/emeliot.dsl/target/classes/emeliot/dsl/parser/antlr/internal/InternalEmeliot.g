...
@lexer::header {
package emeliot.dsl.parser.antlr.internal;
...
@parser::members {
    ...
    public InternalEmeliotParser(TokenStream input, EmeliotGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected EmeliotGrammarAccess getGrammarAccess() {
...
@after {
	...
	(
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getModelAccess().getMutationsMutationParserRuleCall_3_0());
				}
				lv_mutations_3_0=ruleMutation
				{
					if ($current==null) {
...
entryRuleMutation returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMutationRule()); }
	iv_ruleMutation=ruleMutation
	{ $current=$iv_ruleMutation.current; }
	EOF;

// Rule Mutation
ruleMutation returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		otherlv_0='mutation'
		{
			newLeafNode(otherlv_0, grammarAccess.getMutationAccess().getMutationKeyword_0());
		}
		(
			(
				lv_name_1_0=RULE_ID
				{
					newLeafNode(lv_name_1_0, grammarAccess.getMutationAccess().getNameIDTerminalRuleCall_1_0());
				}
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getMutationRule());
					}
					setWithLastConsumed(
						$current,
						"name",
		...
		(
			(
				lv_timeSeries_2_0=RULE_STRING
				{
					newLeafNode(lv_timeSeries_2_0, grammarAccess.getMutationAccess().getTimeSeriesSTRINGTerminalRuleCall_2_0());
				}
				{
					if ($current==null) {
						$current = createModelElement(grammarAccess.getMutationRule());
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getMutationAccess().getTimeSJvmTypeReferenceParserRuleCall_3_0());
				}
				lv_timeS_3_0=ruleJvmTypeReference
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getMutationRule());
					}
					set(
						$current,
						"timeS",
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getMutationAccess().getOperationXBlockExpressionParserRuleCall_4_0());
				}
				lv_operation_4_0=ruleXBlockExpression
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getMutationRule());
					}
